  ...
  constructor(props, context) {
    ...
    if (children) {
      React.Children.forEach(children, child => {
        if (isUIElement(child, ['Input', 'Select']) && isDirty(child.props, true)) {
          this.state.dirty = true;
        }
        if (isUIElement(child, ['Input']) && isAdornedStart(child.props)) {
...
FormControl.childContextTypes = {
  uiFormControl: PropTypes.object.isRequired,
};

export default withStyles(styles, { name: 'UIFormControl' })(FormControl);
