...
describe('<Tab />', () => {
  ...
  describe('prop: onClick', () => {
    it('should be called when a click is triggered', () => {
      ...
      const wrapper = shallow(<Tab textColor="inherit" onClick={handleClick} onChange={() => {}} />);
  ...
  describe('prop: label', () => {
    ...
    it('should render with text wrapping', () => {
      ...
      instance.label = { getClientRects: sinon.stub().returns({ length: 2 }) };
  ...
  describe('prop: classes', () => {
    it('should render label with a custom label class', () => {
      const wrapper = shallow(<Tab textColor="inherit" label="foo" classes={{ label: 'MyLabel' }} />);
      const label = wrapper
        .childAt(0)
        .childAt(0)
        .childAt(0);
  ...
  it('should have a ref on label property', () => {
    ...
    const instance = mount(<TabNaked textColor="inherit" label="foo" classes={classes} />).instance();
