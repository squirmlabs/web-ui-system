...
import Grow from '@symbols/core/transitions/Grow';
...
class Popover extends React.Component {
  ...
  getPositioningStyle = element => {
    ...
    warning(
      ...
      [
        'Storyline-UI: the popover component is too tall.',
  ...
  getContentAnchorOffset(element) {
    ...
    if (getContentAnchorEl && anchorReference === 'anchorEl') {
      ...
      warning(
        ...
        [
          'Storyline-UI: you can not change the default `anchorOrigin.vertical` value ',
...
export default withStyles(styles, { name: 'UIPopover' })(Popover);
