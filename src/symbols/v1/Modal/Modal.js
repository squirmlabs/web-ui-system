...
import RefHolder from '@symbols/core/internal/RefHolder';
import Portal from '../Portal';
import addEventListener from '@symbols/core/addEventListener';
import { createChainedFunction } from '@symbols/core/helpers';
    ...
    if (dialogElement && !contains(dialogElement, currentActiveElement)) {
      ...
      if (!dialogElement.hasAttribute('tabIndex')) {
        warning(
          false,
          [
            'Storyline-UI: the modal content node does not accept focus.',
...
export default withStyles(styles, { flip: false, name: 'UIModal' })(Modal);
