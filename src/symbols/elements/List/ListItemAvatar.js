...
function ListItemAvatar(props, context) {
  ...
  if (context.dense === undefined) {
    warning(
      false,
      `Storyline-UI: <ListItemAvatar> is a simple wrapper to apply the dense styles
...
ListItemAvatar.uiName = 'ListItemAvatar';

export default withStyles(styles, { name: 'UIListItemAvatar' })(ListItemAvatar);
