...
import withTheme from '@symbols/core//withTheme';
import { reflow, getTransitionProps } from '@symbols/core/transitions/utils';
...
class Grow extends React.Component {
  ...
  render() {
    const {
      children, onEnter, onExit, style: styleProp, theme, timeout, ...other
    } = this.props;
