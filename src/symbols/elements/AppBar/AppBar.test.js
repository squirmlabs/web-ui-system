...
Hello World
  ...
  it('should render an secondary app bar', () => {
    const wrapper = shallow(<AppBar color="secondary">
Hello World
                            </AppBar>);
    assert.strictEqual(wrapper.hasClass(classes.root), true);
    assert.strictEqual(
  ...
  describe('Dialog', () => {
    it('should add a .ui-fixed class', () => {
      const wrapper = shallow(<AppBar position="fixed">
Hello World
                              </AppBar>);
      assert.strictEqual(wrapper.hasClass('ui-fixed'), true);
    });
  });
});
