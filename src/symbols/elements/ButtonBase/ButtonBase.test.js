...
import { createShallow, createMount, getClasses, unwrap } from '@symbols/core/test-utils';
import { focusKeyPressed } from '@symbols/core/keyboardFocus';
...
Hello
    ...
    it('should change the button type', () => {
      const wrapper = shallow(<ButtonBase type="submit">
Hello
      </ButtonBase>);
      assert.strictEqual(wrapper.name(), 'button');
    ...
    it('should spread props on button', () => {
      const wrapper = shallow(<ButtonBase data-test="hello">
Hello
      </ButtonBase>);
...
Hello
    ...
    it('should change the button type to span and set role="button"', () => {
      const wrapper = shallow(<ButtonBase component="span">
Hello
                              </ButtonBase>);
      assert.strictEqual(wrapper.name(), 'span');
    ...
    it('should automatically change the button to an a element when href is provided', () => {
      const wrapper = shallow(<ButtonBase href="http://google.com">
Hello
      </ButtonBase>);
    ...
    it('should not set role="button" on an invalid component', () => {
      const wrapper = shallow(<ButtonBase component="a">
Hello
      </ButtonBase>);
      assert.strictEqual(wrapper.name(), 'a');
      assert.strictEqual(wrapper.props().type, undefined);
    ...
    it('should not change the button to an a element', () => {
      const wrapper = shallow(<ButtonBase component="span" href="http://google.com">
          Hello
      </ButtonBase>,);
      assert.strictEqual(wrapper.name(), 'span');
      assert.strictEqual(wrapper.props().href, 'http://google.com');
...
Hello
    ...
    it('should not have a focus ripple by default', () => {
      wrapper.instance().ripple = { pulsate: sinon.spy() };
    ...
    it('should start the ripple when the mouse is pressed', () => {
      wrapper.instance().ripple = { start: sinon.spy() };
    ...
    it('should stop the ripple when the mouse is released', () => {
      wrapper.instance().ripple = { stop: sinon.spy() };
  ...
  describe('focusRipple', () => {
    ...
    beforeEach(() => {
      wrapper = shallow(<ButtonBase focusRipple>
Hello
      </ButtonBase>);
    });
    ...
    /**
     * Getting 'AssertionError'
     */
    // it('should stop pulsate and start a ripple when the space button is pressed', () => {
    //   wrapper.instance().ripple = { stop: sinon.spy((event, cb) => cb()), start: sinon.spy() };
    ...
    //   wrapper.instance().ripple = { stop: sinon.spy((event, cb) => cb()), pulsate: sinon.spy() };
  ...
  describe('mounted tab press listener', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = mount(<ButtonBaseNaked classes={{}} id="test-button">
          Hello
      </ButtonBaseNaked>,);
  ...
  describe('prop: disabled', () => {
    it('should apply the right tabIndex', () => {
      const wrapper = shallow(<ButtonBase disabled>
Hello
                              </ButtonBase>);
    ...
    it('should also apply it when using component', () => {
      const wrapper = shallow(<ButtonBase disabled component="button">
          Hello
      </ButtonBase>,);
...
Hello
    ...
    it('should not apply disabled on a span', () => {
      const wrapper = shallow(<ButtonBase component="span" disabled>
          Hello
                              </ButtonBase>,);
  ...
  describe('prop: component', () => {
    it('should allow to use a link component', () => {
      ...
      const wrapper = shallow(<ButtonBase component={Link}>
Hello
      </ButtonBase>);
  ...
  describe('handleFocus()', () => {
    ...
    it('when disabled should not persist event', () => {
      const wrapper = mount(<ButtonBaseNaked classes={{}} disabled>
          Hello
      </ButtonBaseNaked>,);
      const instance = wrapper.instance();
      const eventMock = { persist: sinon.spy() };
    ...
    it('onKeyboardFocusHandler() should propogate call to onKeyboardFocus prop', () => {
      ...
      const onKeyboardFocusSpy = sinon.spy();
      const wrapper = mount(<ButtonBaseNaked classes={{}} component="span" onKeyboardFocus={onKeyboardFocusSpy}>
          Hello
      </ButtonBaseNaked>,);
      const instance = wrapper.instance();
    ...
    it('should work with a functionnal component', () => {
      ...
      const wrapper = mount(<ButtonBaseNaked classes={{}} component={MyLink}>
          Hello
      </ButtonBaseNaked>,);
      const instance = wrapper.instance();
...
Hello
  ...
  describe('prop: ref', () => {
    it('should be able to get a ref of the root element', () => {
      ...
      const ref = sinon.spy();
      mount(<ButtonBaseRef rootRef={ref}>
Hello
      </ButtonBaseRef>);
