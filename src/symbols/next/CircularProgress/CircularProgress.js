...
export const styles = theme => ({
  ...
  indeterminate: {
    animation: 'ss-progress-circular-rotate 1.4s linear infinite',
  },
  ...
  circleIndeterminate: {
    animation: 'ss-progress-circular-dash 1.4s ease-in-out infinite',
    // Some default value that looks fine waiting for the animation to kicks in.
    strokeDasharray: '80px, 200px',
    strokeDashoffset: '0px', // Add the unit to fix a Edge 16 and below bug.
  },
  '@keyframes ss-progress-circular-rotate': {
    '100%': {
      transform: 'rotate(360deg)',
    },
  },
  '@keyframes ss-progress-circular-dash': {
    '0%': {
...
export default withStyles(styles, { name: 'SSCircularProgress', flip: false })(CircularProgress);
