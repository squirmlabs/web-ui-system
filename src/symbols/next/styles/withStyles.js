...
const withStyles = (stylesOrCreator, options = {}) => Component => {
  ...
  class WithStyles extends React.Component {
    constructor(props, context) {
      ...
      const { ssThemeProviderOptions } = context;
      if (ssThemeProviderOptions) {
        if (ssThemeProviderOptions.sheetsManager) {
          this.sheetsManager = ssThemeProviderOptions.sheetsManager;
        }
        this.sheetsCache = ssThemeProviderOptions.sheetsCache;
        this.disableStylesGeneration = ssThemeProviderOptions.disableStylesGeneration;
      }
