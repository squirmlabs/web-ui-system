...
describe('<SelectInput />', () => {
  ...
  describe('prop: SelectDisplayProps', () => {
    it('should apply additional properties to the clickable div element', () => {
      ...
      const selectDisplay = wrapper.find('[data-ss-test="SelectDisplay"]');
  ...
  describe('prop: onChange', () => {
    ...
    it('should call handleClose', () => {
      ...
      const portalLayer = wrapper
        ...
        .instance()
        .getMountNode();
      const backdrop = portalLayer.querySelector('[data-ss-test="Backdrop"]');
      backdrop.click();
      assert.strictEqual(wrapper.state().open, false);
    });
  });
  ...
  describe('prop: multiple', () => {
    it('should take precedence', () => {
      ...
      assert.strictEqual(wrapper.find('[data-ss-test="SelectDisplay"]').props().tabIndex, 0);
    });
  });
