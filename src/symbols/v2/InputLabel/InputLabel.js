...
function InputLabel(props, context) {
  ...
  const { ssFormControl } = context;

  let shrink = shrinkProp;
  if (typeof shrink === 'undefined' && ssFormControl) {
    shrink = ssFormControl.filled || ssFormControl.focused || ssFormControl.adornedStart;
  }
...
export default withStyles(styles, { name: 'SSInputLabel' })(InputLabel);
