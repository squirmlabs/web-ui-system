...
import createSSTheme from '../styles/createSSTheme';
...
describe('<Slide />', () => {
  ...
  describe('prop: direction', () => {
    it('should update the position', () => {
      const wrapper = mount(
        <SlideNaked {...defaultProps} theme={createSSTheme()} in={false} direction="left" />,
      );
  ...
  describe('mount', () => {
    it('should work when initially hidden', () => {
      const wrapper = mount(
        <SlideNaked theme={createSSTheme()} in={false}>
          <div>Foo</div>
        </SlideNaked>,
      );
      const transition = wrapper.instance().transitionRef;
  ...
  describe('resize', () => {
    ...
    it('should recompute the correct position', () => {
      const wrapper = mount(
        <SlideNaked theme={createSSTheme()} direction="up" in={false}>
          <div>Foo</div>
        </SlideNaked>,
      );
