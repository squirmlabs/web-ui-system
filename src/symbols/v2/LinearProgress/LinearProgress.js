...
export const styles = theme => ({
  ...
  bar1Indeterminate: {
    ...
    animation: 'ss-indeterminate1 2.1s cubic-bezier(0.65, 0.815, 0.735, 0.395) infinite',
  },
  ...
  bar2Indeterminate: {
    width: 'auto',
    willChange: 'left, right',
    animation: 'ss-indeterminate2 2.1s cubic-bezier(0.165, 0.84, 0.44, 1) infinite',
...
export default withStyles(styles, { name: 'SSLinearProgress' })(LinearProgress);
