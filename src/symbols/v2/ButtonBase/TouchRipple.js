...
export const styles = theme => ({
  ...
  rippleVisible: {
    opacity: 0.3,
    transform: 'scale(1)',
    animation: `ss-ripple-enter ${DURATION}ms ${theme.transitions.easing.easeInOut}`,
  },
  ...
  childLeaving: {
    opacity: 0,
    animation: `ss-ripple-exit ${DURATION}ms ${theme.transitions.easing.easeInOut}`,
  },
  ...
  childPulsate: {
    ...
    left: 0,
    top: 0,
    animation: `ss-ripple-pulsate 2500ms ${theme.transitions.easing.easeInOut} 200ms infinite`,
  },
  '@keyframes ss-ripple-enter': {
    '0%': {
      transform: 'scale(0)',
      opacity: 0.1,
    },
...
export default withStyles(styles, { flip: false, name: 'SSTouchRipple' })(TouchRipple);
