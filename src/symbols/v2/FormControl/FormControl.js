  ...
  constructor(props) {
    ...
    if (children) {
      React.Children.forEach(children, child => {
        if (!isSSElement(child, ['Input', 'Select'])) {
          return;
        }
        ...
        const input = isSSElement(child, ['Select']) ? child.props.input : child;
...
export default withStyles(styles, { name: 'SSFormControl' })(FormControl);
