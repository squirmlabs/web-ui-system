...
import { isSSElement } from '../utils/reactHelpers';
...
class ListItem extends React.Component {
  ...
  render() {
    ...
    const hasAvatar = children.some(value => isSSElement(value, ['ListItemAvatar']));
    const hasSecondaryAction =
      children.length && isSSElement(children[children.length - 1], ['ListItemSecondaryAction']);
...
export default withStyles(styles, { name: 'SSListItem' })(ListItem);
