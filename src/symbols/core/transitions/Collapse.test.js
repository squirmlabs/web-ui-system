  ...
  describe('transition lifecycle', () => {
    ...
    describe('handleEntering()', () => {
      ...
      it('should call handleEntering', () => {
        const onEnteringStub = sinon.spy();
      ...
      describe('timeout', () => {
        ...
        beforeEach(() => {
          ...
          theme.transitions.getAutoHeightDuration = sinon.stub().returns('woofCollapseStub');
    ...
    describe('handleExiting()', () => {
      ...
      describe('timeout', () => {
        ...
        beforeEach(() => {
          theme = instance.props.theme;
          restore = theme.transitions.getAutoHeightDuration;
          theme.transitions.getAutoHeightDuration = sinon.stub().returns('woofCollapseStub2');
          wrapper.setProps({ timeout: 'auto' });
          instance = wrapper.instance();
        });
