...
//
// It's inspired by
// https://github.com/cssinjs/styleguide/blob/4e6a05dd3f7b6572fdd3ab216861d9e446c20331/src/utils/createGenerateClassName.js
export default function createGenerateClassName(options = {}) {
  const { dangerouslyUseGlobalCSS = false, productionPrefix = 'SquirmlabsComponent' } = options;
  ...
  if (
    ...
    productionPrefix === 'SquirmlabsComponent'
  ) {
    generatorCounter += 1;
    if (generatorCounter > 2) {
      // eslint-disable-next-line no-console
      console.error([
        'Storyline-UI: we have detected more than needed creation of the class name generator.',
